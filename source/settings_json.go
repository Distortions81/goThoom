...
var settingsSchema = []settingsSchemaEntry{
	...
	{field: "InterpolateSmallMovingPictures", category: settingsRendering, name: "interpolate_small_moving_pictures"},
	...
	{field: "DisabledHDPictures", category: settingsRendering, name: "disabled_hd_pictures"},
	{field: "ReplacementEffects", category: settingsRendering, name: "replacement_effects"},
	{field: "DisabledReplacementEffects", category: settingsRendering, name: "disabled_replacement_effects"},
	...
	{field: "ChatTTSSay", category: settingsChat, name: "text_to_speech_say"},
	{field: "ChatTTSWhisper", category: settingsChat, name: "text_to_speech_whispers"},
	{field: "ChatTTSYell", category: settingsChat, name: "text_to_speech_yells"},
	{field: "ChatTTSThink", category: settingsChat, name: "text_to_speech_thoughts"},
	{field: "ChatTTSAction", category: settingsChat, name: "text_to_speech_actions"},
	{field: "ChatTTSPonder", category: settingsChat, name: "text_to_speech_ponders"},
	{field: "ChatTTSMonster", category: settingsChat, name: "text_to_speech_monsters"},
	{field: "ChatTTSSelf", category: settingsChat, name: "text_to_speech_self"},
	{field: "ChatTTSNotifications", category: settingsChat, name: "text_to_speech_notifications"},
	...
	{field: "TiledCustomLayout", category: settingsWindows, name: "custom_tiled_layout"},
	...
	{field: "TiledLeftBottom", category: settingsWindows, name: "tiled_left_bottom"},
	{field: "TiledRightBottom", category: settingsWindows, name: "tiled_right_bottom"},
	{field: "TiledLeftWidth", category: settingsWindows, name: "tiled_left_width"},
	{field: "TiledRightWidth", category: settingsWindows, name: "tiled_right_width"},
	{field: "TiledSideGameWidth", category: settingsWindows, name: "tiled_side_game_width"},
	{field: "TiledSideTopSplit", category: settingsWindows, name: "tiled_side_top_split"},
	{field: "TiledMessagesTopHeight", category: settingsWindows, name: "tiled_messages_top_height"},
	{field: "TiledMessagesBottomHeight", category: settingsWindows, name: "tiled_messages_bottom_height"},
	{field: "TiledMessagesSplit", category: settingsWindows, name: "tiled_messages_split"},
	{field: "TiledMessagesStacked", category: settingsWindows, name: "tiled_messages_stacked"},
	{field: "TiledInventoryLeft", category: settingsWindows, name: "tiled_inventory_left"},
	{field: "TiledConsoleLeft", category: settingsWindows, name: "tiled_console_left"},
