...
var scriptFunctionPermissions = map[string]string{
	...
	"CreateWindow": "windows", "OpenSettings": "windows", "AddToolbar": "windows", "OverlayRect": "windows", "OverlayCircle": "windows", "OverlayText": "windows", "OverlayImage": "windows",
	"OverlayFollowPlayer": "windows", "OverlayFollowMobile": "windows", "OverlayFollowBackground": "windows",
...
func applyScriptPermissions(owner string, selected map[string]bool, blockAll bool) error {
	...
	restartConnectedSessionScript(owner, "permissions changed")
	return nil
}
