...
func Init() {
	...
	gt2.SetMobileOutline(456, 255, 64, 64, 255)
	gt2.ClearMobileOutline(123)
	gt2.SetNamedMobileTint("Example Player", 255, 255, 128, 255)
	gt2.ClearNamedMobileTint("Example Player")
	gt2.SetNamedMobileOutline("Example Player", 255, 255, 0, 255)
	gt2.ClearNamedMobileOutline("Example Player")
	gt2.FlashMobile(7, 255, 48, 48, 255, time.Second)
	w, h := gt2.WorldSize()
	gt2.Store("world_w", w)
	gt2.Store("world_h", h)
